...
static OpenGazer::Point subpixelminimum(const IplImage *values) {
    CvPoint maxpoint;
				  ...
				  IplImage *image)
{
    ...
    headtracker.updatetracker(); // throws Tracking Exception
...
//     OpenGazer::Point mxpoint = subpixelminimum(eyegreytemp4);
